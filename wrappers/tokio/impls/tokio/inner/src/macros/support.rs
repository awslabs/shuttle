...
// CHANGED: Changed to use rand from Shuttle
#[doc(hidden)]
...
// CHANGED: Changed to always be `Poll::Ready(())` (ie. same as Tokio when coop is not enabled). We don't model cooperative scheduling.
#[doc(hidden)]
#[inline]
