...
pub trait StreamExt: Stream {
    ...
    ///
    /// ```
    /// use shuttle_tokio_impl_inner_stream::{StreamExt, Stream};
    /// use tokio::sync::mpsc;
    /// use tokio::time;
    ///
    ...
    ///
    /// ```
    /// use shuttle_tokio_impl_inner_stream::{Stream, StreamExt};
    ///
    /// use std::pin::Pin;
    ...
    /// # #[tokio::main]
    /// # async fn main() {
    /// use shuttle_tokio_impl_inner_stream::{self as stream, *};
    ///
    ...
    /// # async fn main() {
    /// use shuttle_tokio_impl_inner_stream::{StreamExt, wrappers::IntervalStream};
    /// use std::time::Duration;
    ...
    /// ```rust,no_run
    /// use std::time::Duration;
    /// use shuttle_tokio_impl_inner_stream::StreamExt;
    ///
    /// # async fn dox() {
