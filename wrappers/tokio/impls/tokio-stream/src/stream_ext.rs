...
pub trait StreamExt: Stream {
    ...
    ///
    /// ```ignore
    /// use shuttle_tokio_stream_impl::{StreamExt, Stream};
    /// use tokio::sync::mpsc;
    /// use tokio::time;
    ///
    ...
    ///
    /// ```ignore
    /// use shuttle_tokio_stream_impl::{Stream, StreamExt};
    ///
    /// use std::pin::Pin;
    ...
    /// # #[tokio::main]
    /// # async fn main() {
    /// use shuttle_tokio_stream_impl::{self as stream, *};
    ///
    ...
    /// # async fn main() {
    /// use shuttle_tokio_stream_impl::{StreamExt, wrappers::IntervalStream};
    /// use std::time::Duration;
